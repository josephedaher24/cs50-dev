...
5. Set up your GitHub account and provide GitHub a 'key' so your account on `plank` can access GitHub; follow these [instructions](https://github.com/CS50Fall2023/home/blob/main/logistics/systems.md), and then return here.
